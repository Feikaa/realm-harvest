...
import IconIron from '../images/iron_bar.png';
...
export default function CraftSection(props: any) {
  ...
  // type = position in the items array
  // material is in the form of [[area_num, resource_num], ...]
  // costs is amount of each material
    ...
    <Paper style={{ height: 672, width: '100%', overflow: 'auto' }}>
        <Box sx={{ padding: "2%" }}>
            ...
            <Stack direction="row" spacing={1} justifyContent='space-between'>
                    ...
                    <Stack direction="row" justifyContent={"flex-end"} spacing={1}>
                    <Typography sx={{ verticalAlign: 'middle', display: 'inline-flex' }}>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(1, [[0,1]], [5], 1)}} disabled={resources[0].resources[1].quantity < 5 ? true : false}>
                            +1
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(1, [[0,1]], [5], 10)}} disabled={resources[0].resources[1].quantity < 5 * 10 ? true : false}>
                            +10
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(1, [[0,1]], [5], Math.floor(resources[0].resources[1].quantity / 5))}} disabled={resources[0].resources[1].quantity < 5 ? true : false}>
            ...
            <Stack direction="row" spacing={1} justifyContent='space-between'>
                    ...
                    <Stack direction="row" justifyContent={"flex-end"} spacing={1}>
                    <Typography sx={{ verticalAlign: 'middle', display: 'inline-flex' }}>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(3, [[0,2]], [10], 1)}} disabled={resources[0].resources[2].quantity < 10 ? true : false}>
                            +1
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(3, [[0,2]], [10], 10)}} disabled={resources[0].resources[2].quantity < 10 * 10 ? true : false}>
                            +10
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(3, [[0,2]], [10], Math.floor(resources[0].resources[2].quantity / 10))}} disabled={resources[0].resources[2].quantity < 10 ? true : false}>
            ...
            <Stack direction="row" spacing={1} justifyContent='space-between'>
                    ...
                    <Stack direction="row" justifyContent={"flex-end"} spacing={1}>
                    <Typography sx={{ verticalAlign: 'middle', display: 'inline-flex' }}>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(2, [[3,0], [3,1], [3,2]], [10, 5, 2], 1)}} disabled={resources[3].resources[0].quantity >= 10 ? resources[3].resources[1].quantity >= 5 ? resources[3].resources[2].quantity >= 2 ? false : true : true : true}>
                            +1
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(2, [[3,0], [3,1], [3,2]], [10, 5, 2], 10)}} disabled={resources[3].resources[0].quantity >= 10 ? resources[3].resources[1].quantity >= 5 ? resources[3].resources[2].quantity >= 2 ? false : true : true : true}>
                            +10
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(2, [[3,0], [3,1], [3,2]], [10, 5, 2], Math.min(Math.floor(resources[3].resources[0].quantity / 10), Math.floor(resources[3].resources[1].quantity / 5), Math.floor(resources[3].resources[2].quantity / 2)))}} disabled={resources[3].resources[0].quantity >= 10 ? resources[3].resources[1].quantity >= 5 ? resources[3].resources[2].quantity >= 2 ? false : true : true : true}>
            ...
            <Stack direction="row" spacing={1} justifyContent='space-between'>
                    <Typography variant="button" component="div" color={"#000000"} display="flex" alignItems="center" style={courierFontStyle}>
                    Iron Bar
                    <img src={IconIron} alt="Iron Icon" width="64px" height="64px" />x{items[4].quantity}&nbsp;&nbsp;
                    <Box alignItems="center" justifyContent="center">
                        Used to make tools
                    </Box>
                    </Typography>
                    <Typography variant="button" component="div" color={"#000000"} display="flex" alignItems="center" style={courierFontStyle}>
                        <Grid container spacing={0} direction="row" alignItems="center" justifyContent="right">
                            ...
                            <React.Fragment>
                            <Box sx={{border: 1, width: "50px"}}>
                            <img src={Ore} alt="Ore" height="48" width="48"></img>
                            <br />
                            5
                            </Box>
                            </React.Fragment>
                    ...
                    <Stack direction="row" justifyContent={"flex-end"} spacing={1}>
                    <Typography sx={{ verticalAlign: 'middle', display: 'inline-flex' }}>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(4, [[2,0], [2,1]], [10, 5], 1)}} disabled={resources[2].resources[0].quantity >= 10 ? resources[2].resources[1].quantity >= 5 ? false : true : true}>
                            +1
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(4, [[2,0], [2,1]], [10, 5], 10)}} disabled={resources[2].resources[0].quantity >= 10 * 10 ? resources[2].resources[1].quantity >= 5 * 10 ? false : true : true}>
                            +10
                        </Button>
                        <Button style={courierFontStyle} variant='contained' color='secondary' onClick={() => {craftItem(4, [[2,0], [2,1]], [10, 5], Math.min(Math.floor(resources[2].resources[0].quantity / 10), Math.floor(resources[2].resources[1].quantity / 5)))}} disabled={resources[2].resources[0].quantity >= 10 ? resources[2].resources[1].quantity >= 5 ? false : true : true}>
                            Max (+{Math.min(Math.floor(resources[2].resources[0].quantity / 10), Math.floor(resources[2].resources[1].quantity / 5))})
                        </Button>
                    </Typography>
                    </Stack>
                    </Stack>
