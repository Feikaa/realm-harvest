// icon:hand-back-fist | Fontawesome https://fontawesome.com/ | Fontawesome
import * as React from "react";

function IconHandBackFist(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 448 512"
      fill="currentColor"
...
export default IconHandBackFist;
